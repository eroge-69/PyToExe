...
FOLDERS = [
    "relay","seat","seataccess","selfdestruct","shieldgenerator","thrusters",
    "usableitems","weapons","armor","cargogrid","controller","cooler",
    "countermeasures","dashboard","displays","dockingport","fuel_intakes",
    "fueltanks","jumpdrive","landingsystem","lifesupport","missile_racks",
    "powerplant","quantumdrive","radar"
]
