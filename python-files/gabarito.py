...
class LetraApp:
    def __init__(self, root):
        ...
        # Atualiza contador sempre que o texto mudar (inclusive ao apagar tudo)
    ...
    def tecla_pressionada(self, event):
        ...
        # Permite atalhos e edição manual
        if event.state & 0x4:  # Ctrl pressionado (Ctrl+C, Ctrl+V, Ctrl+A etc.)
            return
        ...
        # Permite Delete, Setas, etc.
        else:
            pass  # não bloqueia outras teclas
