...
class LetraApp:
    def __init__(self, root):
        ...
        # Evento de teclado → ligado diretamente ao Text (corrige duplicação)
    ...
    def tecla_pressionada(self, event):
        ...
        # Ignora combinações com Ctrl (Ctrl+C, Ctrl+V, etc.)
        if event.state & 0x4:  # Bitmask do Ctrl pressionado
            return
        ...
        if event.char.isalpha():
            ...
            return "break"  # impede inserção dupla
