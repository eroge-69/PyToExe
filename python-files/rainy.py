...
def display_menu():
    if any("android" in value.lower() for value in os.environ.values()):
        pystyle.Write.Print(pystyle.Center.XCenter('''.__                .__                                   
                         ...
                         .....     .                        ..                   ...     ...         .....                                ...     ..      ..     
                       .d88888Neu. 'L    :~"""88hx.      :**888H: `: .xH""    .=*8888n.."%888:    .H8888888h.  ~-.    x8h.     x8.      x*8888x.:*8888: -"888:   
     ...     ..        F""""*8888888F  .~      ?888x    X   `8888k XX888     X    ?8888f '8888    888888888888x  `> :88888> .x8888x.   X   48888X `8888H  8888   
  :~""888h.:^"888:    *      `"*88*"   X       '8888k  '8hx  48888 ?8888     88x. '8888X  8888>  X~     `?888888hx~  `8888   `8888f   X8x.  8888X  8888X  !888>  
 8X   `8888X  8888>    -....    ue=:.    H8h    8888X  '8888 '8888 `8888    '8888k 8888X  '"*8h. '      x8.^"*88*"    8888    8888'   X8888 X8888  88888   "*8%- 
X888n. 8888X  ?888>           :88N  `   ?888~   8888    %888>'8888  8888     "8888 X888X .xH8     `-:- X8888x         8888    8888    '*888!X8888> X8888  xH8>   
'88888 8888X   ?**h.          9888L      %X   .X8*"       "8 '888"  8888       `8" X888!:888X          488888>        8888    8888      `?8 `8888  X888X X888>   
  `*88 8888~ x88x.     uzu.   `8888L     .-"``"tnx.      .-` X*"    8888      =~`  X888 X888X        .. `"88*         8888    8888      -^  '888"  X888  8888>   
 ..<"  88*`  88888X  ,""888i   ?8888    :~      8888.      .xhx.    8888       :h. X8*` !888X      x88888nX"      .   8888    8888       dx '88~x. !88~  8888>   
    ..XC.    `*8888k 4  9888L   %888>   ~       X8888    .H88888h.~`8888.>    X888xX"   '8888..:  !"*8888888n..  :  -n88888x>"88888x-  .8888Xf.888x:!    X888X.: 
  :888888H.    `%88> '  '8888   '88%   ...      '8888L  .~  `%88!` '888*~   :~`888f     '*888*"  '    "*88888888*     `%888"  4888!`  :""888":~"888"     `888*"  
 <  `"888888:    X"       "*8Nu.z*"   '888k     '8888f        `"     ""         ""        `"`            ^"***"`        `"      ""        "~'    "~        ""    
       %888888x.-`                     8888>    <8888                                                                                                            
         ""**""                        `888>    X888~                                                                                                            
                                        '"88...x8""                                                                                                                                                     
                                 TGK: @rainysoftware
...
'88888 8888X   ?**h.          9888L      %X   .X8*"       "8 '888"  8888       `8" X888!:888X          488888>        8888    8888      `?8 `8888  X888X X888>   
 ...
 <  `"888888:    X"       "*8Nu.z*"   '888k     '8888f        `"     ""         ""        `"`            ^"***"`        `"      ""        "~'    "~        ""    
  ...
  └═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════┘ 
                    [77] Инфо              САБ НА ТГК           [99] Выход'''), pystyle.Colors.red_to_white, interval = 0.0001)
    print()
    print()
while True:
    clear() 
