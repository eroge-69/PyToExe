# -*- coding: utf-8 -*-
"""
Created on Fri Jun 27 22:16:11 2025
...
class ClaimAuditor:
    ...
    def run_checks(self):
        ...
        for i, row in enumerate(df.itertuples(index=False, name=None)):
            ...
            # Only check key required fields
            required_fields = ["Employee ID", "Employee", "Purpose", "Approved Amount"]
            ...
            purpose_missing = not claim.description.strip()
            ...
            # Add Missing Purpose field last
            if purpose_missing:
