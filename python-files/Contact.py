...
update_datetime()  # Start the clock
...
tk.Button(button_frame, text="Clear", font=FONT, command=clear_fields, width=10).pack(pady=5)
tk.Button(button_frame, text="Exit", font=FONT, command=root.quit, width=10,
          fg="red", bg="#ffcccc", activebackground="#ff9999", activeforeground="black").pack(pady=5)
...
root.grid_columnconfigure(3, weight=0)  # for datetime label column
