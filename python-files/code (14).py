# notapro.py (versão com Nova Janela e menu de contexto)
...
import os
import sys
import subprocess # --- NOVO: Importado para lançar um novo processo
...
class NotaPro(tk.Tk):
    ...
    def _bind_shortcuts(self):
        ...
        # --- NOVO ATALHO ---
        self.bind("<Control-Shift-n>", lambda e: self._new_window())
