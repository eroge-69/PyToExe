...
if __name__ == "__main__":
    ...
    # Sau đó mới menu nhập key
    if not check_license():
        sys.exit(0)

    # Nếu pass thì chạy tiếp
    try:
   ...
   # ──────────────────────────── VISUAL THEME (Neverlose Sakura) ────────────────────────────
with dpg.theme() as sakura_theme:
    with dpg.theme_component(dpg.mvAll):
        # Màu nền & viền
        dpg.add_theme_color(dpg.mvThemeCol_WindowBg, (45, 45, 55), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_ChildBg, (50, 50, 60), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_PopupBg, (45, 45, 55), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_Border, (200, 182, 193), category=dpg.mvThemeCat_Core)

        # Text
        dpg.add_theme_color(dpg.mvThemeCol_Text, (255, 255, 255), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_TextDisabled, (180, 170, 170), category=dpg.mvThemeCat_Core)

        # Button
        dpg.add_theme_color(dpg.mvThemeCol_Button, (255, 192, 203), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered, (255, 182, 193), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_ButtonActive, (255, 105, 180), category=dpg.mvThemeCat_Core)

        # Tab
        dpg.add_theme_color(dpg.mvThemeCol_Tab, (70, 70, 80), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_TabHovered, (255, 182, 193), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_TabActive, (255, 192, 203), category=dpg.mvThemeCat_Core)

        # Slider & Frame
        dpg.add_theme_color(dpg.mvThemeCol_FrameBg, (55, 55, 65), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered, (255, 182, 193), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive, (255, 105, 180), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_SliderGrab, (255, 192, 203), category=dpg.mvThemeCat_Core)
        dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive, (255, 105, 180), category=dpg.mvThemeCat_Core)
...
# Gắn theme Sakura
dpg.bind_theme(sakura_theme)

# Viewport với title bar OS + nền trùng màu GUI
dpg.create_viewport(title="Neverlose Sakura UI", width=600, height=400, decorated=True)
dpg.set_viewport_clear_color((45, 45, 55, 255))
