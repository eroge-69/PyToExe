...
def crear_interfaz():
    ventana = tk.Tk()
    ventana.title("Buscador de Logs")
    ...
    tk.Button(frame_botones, text="Buscar último log", command=accion_buscar_1).pack(side="left", padx=10)
    tk.Button(frame_botones, text="Buscar últimos 5 logs", command=accion_buscar_5).pack(side="left", padx=10)
