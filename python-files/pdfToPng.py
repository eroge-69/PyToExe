...
class MyHandler(FileSystemEventHandler):
    ...
    def process_pdf(self, pdf_path):
        png_folder = "C:\\etiket"
        output_folder = "C:\\Users\\administrator.ONKA\\Desktop\\New folder"
        convert_pdf_to_png(pdf_path, output_folder)
        #delete_pdf("C:\\etiket")

def convert_pdf_to_png(pdf_path, output_folder,image_size=(800, 800)):
    try:
