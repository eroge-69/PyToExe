...
# Updated with Windows & macOS support, progress bar, and animated 🐱 emoji
        ...
        def run_recovery():
            try:
                ...
                if platform.system() == "Windows":
                    subprocess.run(["diskpart", "/s", "meow_clean.txt"], check=True)
                else:
                ...
                traceback.print_exc()
                messagebox.showerror("💥 Meow:(", f"Recovery failed: {str(e)}")
