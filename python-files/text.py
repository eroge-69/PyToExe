...
class PasswordGeneratorApp:
    ...
    def create_name_based_password(self, name, surname, length):
        # Ad ve soyadı birleştir, sadece harfleri al
    ...
    def create_random_password(self, length):
        ...
        # Minimum gereksinimleri karşıla
        password = [
    ...
    def show_password_window(self, password):
        ...
        tk.Button(button_frame, text="Panoya Kopyala", command=lambda: self.copy_to_clipboard(password),
                  bg="#2196F3", fg="white", font=("Arial", 9)).pack(side="left", padx=(0, 5), fill="x", expand=True)
    ...
    def copy_to_clipboard(self, password):
        try:
            ...
            messagebox.showerror("Hata", f"Parola kopyalanamadı!\nHata: {str(e)}")
