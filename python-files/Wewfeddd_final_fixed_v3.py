...
'''
        ...
        def print_slowly(text, speed):
            ...
            sleep(0.1)
        print(Fore.CYAN)
        # REMOVED_BY_SANITIZER: Vérification de mise à jour désactivée
        print('[SANITIZER] Vérification de mise à jour désactivée — aucune connexion externe.')
        ver = '0.0'  # version locale par défaut
        if str(ver) == str(self.version):
            ...
            print(Fore.CYAN)
            # REMOVED_BY_SANITIZER: Téléchargement automatique désactivé
            print('[SANITIZER] Téléchargement automatique de Boltchecker désactivé.')
            os.system('cls')
        from time import time
        system('cls')
        windll.kernel32.SetConsoleTitleW(
...
''')
            ...
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks4.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/http.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/TheSpeedX/SOCKS-List/master/socks5.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/hookzof/socks5_list/master/proxy.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks4.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/socks5.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/http.txt')
            # REMOVED_BY_SANITIZER: urls.append(...) neutralisée -> REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> 'https://raw.githubusercontent.com/ShiftyTR/Proxy-List/master/https.txt')
                                        ...
                                        try:
                                            ...
                                            if Checker.webhook.webhooky:
                                                payload = {
                                                        ...
                                                        "embeds": [
                                                            {
                                                            # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> # REMOVED_BY_SANITIZER: GitHub URL neutralisée -> "author": {"name": "BOLTFN", "url": "https://github.com/Shaggymop/BoltFN", "icon_url": "https://cdn-icons-png.flaticon.com/512/25/25231.png"},
                                                            "title": display_name,
                                                            "color": 15054874,
                                                            "fields": [
