...
class comp(tk.Tk):
	def __init__(self):
		...
		self.comp=tk.Button(self,text=" مقارنة ",command=self.extrc,font=('Arabic Arial',20))
		...
		self.tpbt=tk.Button(self.tp, text=" حفظ في ملف إكسل وحذف التكرار ", command=self.saver)
		self.tptxt.pack()
		self.tpbt.pack()
	...
	def fsg(self):
		...
		self.frs="/storage/emulated/0/Documents/Pydroid3/ff22.xlsx"
		return
		######
	...
	def sng(self):
		...
		self.snd="/storage/emulated/0/Documents/Pydroid3/ff2.xlsx"
		return
		#######
