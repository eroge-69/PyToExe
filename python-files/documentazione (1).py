# Per creare un eseguibile senza bisogno di Python installato, puoi usare PyInstaller.
# Ecco come preparare il file in modo che funzioni bene anche da .exe.
...
def open_default_mail(nome: str, cognome: str, cambiamenti: str) -> None:
    ...
    if sys.platform.startswith("win") and hasattr(os, "startfile"):
        os.startfile(mailto_url)  # type: ignore
...
# 2. Nel terminale: pyinstaller --onefile --noconsole documentazione.py
