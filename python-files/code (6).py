# notapro.py (versão final revisada)
...
class NotaPro(tk.Tk):
    ...
    def _create_widgets(self):
        self.text_widget = tk.Text(
            ...
            insertbackground="black" # Cor inicial do cursor
        )
    ...
    def _load_npro_file(self, filepath):
        ...
        self.text_widget.config(
            ...
            fg=fg_color,
            insertbackground=fg_color # CORREÇÃO: Define a cor do cursor ao carregar
        )
    ...
    def _change_default_text_color(self):
        ...
        if color and color[1]:
            ...
            self.text_widget.config(insertbackground=color[1]) # CORREÇÃO: Altera a cor do cursor junto
            self._on_text_change(None)
