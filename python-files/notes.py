import os
os.startfile("c:\Users\rpenn\Downloads\new py pork\notes.exe" \")

from tkinter import *
import os
root=Tk()
root.title("romy's")
p=Label(root,text="Rom's Diary*", height="18",width="250",bg='teal',fg='white',font=('Helvetica','20','bold','italic'))
p.pack()
root.configure(bg='teal')
root.geometry('1920x1080')
def notes():
    from tkinter import functions
butt1=Button(root,text="exit",command=exit,bg = "blue",fg='white',padx=40,pady=10,font=('Helvetica','10','bold'))
butt1.pack(padx=25,pady=0)
button=Button(root,text="launch",command=notes,bg = "#636466",fg='white',padx=65,pady=8,font=('Helvetica','10','bold'))
