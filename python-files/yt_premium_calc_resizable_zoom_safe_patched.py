...
class App(tk.Tk):
    def __init__(self):
        ...
        for ent in (self.ent_today, self.ent_expiry):
            ent.bind("<Control-a>", lambda e: (e.widget.select_range(0, "end"), "break"))
            ent.bind("<Control-c>", lambda e: (self.copy_selection(e.widget), "break"))
            ent.bind("<Control-x>", lambda e: (self.cut_selection(e.widget), "break"))
            ent.bind("<Control-v>", lambda e: (self.paste_clipboard(e.widget), "break"))
