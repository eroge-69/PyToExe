...
TOKEN = '8480724735:AAEdbW5fDF4bqp_ASfW6ZNd_ki8JWVn5Mz0'


bot = schoolvocbot.SCHOOLVOCBOT(TOKEN)
...
try:
    ...
    bot.send_message(show hacked, '✅ Connection established!')  # Replace with your chat ID
