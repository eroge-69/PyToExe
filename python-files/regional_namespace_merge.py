...
def collect_ini(path, ignore):
    ...
    keywords = [ 
        ...
        "SangonomiyaKokomi", "Sayu", "Heizou", "ShikanoinHeizou", "Thoma", "YaeMiko", "Yae", "Miko", "Yoimiya", "YumemizukiMizuki", "Mizuki", "Fortune Dreams - Nilou",
        ...
        "Kachina", "Kinich", "Mualani", "Xilonen", "Chasca", "Ororon", "Mavuika", "Citlali", "Iansan", "Childe", "Tartaglia", "Varesa", "Vanesa", "Aloy", "BlingYelan", "Skirk", "Master", "Dainsleif", "Arlecchino", 
        "Father", "Xianyun", 
    ]
