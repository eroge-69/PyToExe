...
# ----- محاولة استيراد playsound -----
try:
    from playsound import playsound
    _playsound_available = True
except ImportError:
    _playsound_available = False
    print("Warning: 'playsound' module not found. Audio features will be disabled.")
...
def play_sound(sound_key):
    """تشغيل ملف صوتي إذا كانت مكتبة playsound متاحة."""
    ...
    if path and os.path.exists(path):
        ...
        print(f"Sound file not found for key: {sound_key} at path: {path}")
