...
loadBTN = ttk.Button(TOPFRAME, style="Blue.TButton")
loadBTN.configure(takefocus="")
loadBTN.configure(text='''CHARGER LES STATISTIQUES''')
EXCELBTN.configure(image=_img4)
loadBTN.configure(compound='left')
loadBTN.configure(command=loading)
loadBTN.pack(side='left', padx=50, pady=0)
