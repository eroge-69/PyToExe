...
print("License loading from Config.ini. Cheeto Private by SganK")
print(' ')
...
purple_mode = config['Options']['Mode']
xspd = float(config['Options']['XSens'])
yspd = float(config['Options']['YSens'])
flyk_sylnt_speed = float(config['Options']['FlickSilent'])
reolad_settings_key = config['Options']['ReloadSettingsKey']
aammbbtt_key = config['Options']['AimbotOn/Off']
rkil_key = config['Options']['RecoilOn/Off']
sylnt_key = config['Options']['SilentOn/Off']
sylnt_activ_key = config['Options']['SilentKeyInGame']
flyk_key = config['Options']['FlickOn/Off']
flyk_activ_key = config['Options']['FlickKeyInGame']
exit_key = config['Options']['Exit']
trgt = config['Options']['Target']
ass_aim = config['Options']['AssistAim']
flyk_plus_aim = config['Options']['FlickWithAim']
