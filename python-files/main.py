...
class RemzWareRobloxChecker:
    def __init__(self):
        ...
        self.window.title("Nine_Steffan Cookie Checker")
    ...
    def create_gui(self):
        ...
        title_label = ctk.CTkLabel(
            title_frame,
            text="Nine_Steffan Cookie Checker",
        ...
        discord_button = ctk.CTkButton(
            social_buttons,
            text="Support",
            command=lambda: webbrowser.open("https://t.me/bog_staff"),
            font=("Helvetica", 14),
            fg_color="#5865F2",
            hover_color="#4752C4",
            width=180,
        ...
        github_button = ctk.CTkButton(
            social_buttons,
            text="Telegram",
            command=lambda: webbrowser.open("https://t.me/neinsteffan"),
            font=("Helvetica", 14),
            fg_color="#333333",
            hover_color="#2b2b2b",
            width=180,
