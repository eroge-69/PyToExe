...
model_path = resource_path("model/mistral-7b-instruct-v0.2.Q4_K_M.gguf")
HISTORY_PATH = resource_path("hist/translation_history.json")
GLOSSARY_PATH = resource_path("data/glossary.json")
...
class DesktopApp(QWidget):
    ...
    def on_translate_finished(self, result, relevant_glossary, last_source, glossary):
        ...
        save_translation_history(self.last_input, result, relevant_glossary, HISTORY_PATH)
    ...
    def add_glossary(self):
        ...
        if fname:
            if fname.endswith('.txt'):
                ...
                add_xlsx_to_json(resource_path('data/glossary.json'), resource_path(fname))
