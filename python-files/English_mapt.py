...
questions = [
    ...
    {
        "question": "What is the best way to stay motivated daily?",
        "options": ["Stay in bed", "Set small goals", "Ignore success", "Compare with others"],
    ...
    {
        "question": "What is the opposite of a motivated mindset?",
        "options": ["Inspired", "Lazy", "Passionate", "Driven"],
        "answer": "Lazy"
    },
    {
        "question": "Which practice helps in building motivation?",
        "options": ["Watching TV all day", "Mindful meditation", "Arguing with friends", "Complaining"],
        "answer": "Mindful meditation"
    },
    {
        "question": "Passion in work leads to:",
        "options": ["Stress", "Disinterest", "Higher performance", "Low energy"],
        "answer": "Higher performance"
    },
    {
        "question": "How can one develop self-motivation?",
        "options": ["Follow negative people", "Set meaningful goals", "Avoid responsibility", "Expect luck"],
        "answer": "Set meaningful goals"
    },
    {
        "question": "Motivated people usually:",
        "options": ["Give up quickly", "Complain often", "Take consistent actions", "Wait for orders"],
        "answer": "Take consistent actions"
    },
    {
        "question": "What does motivation directly impact?",
        "options": ["Sleep duration", "Height", "Productivity", "Hair growth"],
        "answer": "Productivity"
    },
    {
        "question": "Motivation can be increased by:",
        "options": ["Criticizing yourself", "Comparing to others", "Celebrating small wins", "Avoiding challenges"],
        "answer": "Celebrating small wins"
    },
    {
        "question": "One of the best motivational habits is:",
        "options": ["Gossiping", "Complaining", "Daily journaling", "Blaming others"],
        "answer": "Daily journaling"
    },
    {
        "question": "Motivation leads to:",
        "options": ["Inaction", "Focus and achievement", "Confusion", "Excuses"],
        "answer": "Focus and achievement"
    }
]
