...
def Gentare_file(fileName):
    ...
    df_ap['RESERVED2'] = ''
    df_ap['RESERVED2'] = ''
    df_ap = df_ap[['oparation', 'serial', 'Mrn', 'BankCode', 'BRANCH_CODE', 'masterIndcator', 'posNumer', 'POSGrouping', 'ACRONYM', 'ABREV_LOCATION', 'city_code', 'region_code', 'pos_brand_code', 'PROTOCOL_INDEX', 'POS_PROFILE_CODE', 'Trx_prosseing_mod', 'pin_padding', 'Termainal_mod_status', 'currency_code', 'MINIMUM_AMOUNT_C1', 'FLOOR_LIMIT_C1', 'CEILING_LIMIT_C1', 'CURRENCY_CODE_2', 'MINIMUM_AMOUNT_C2', 'FLOOR_LIMIT_C2', 'CEILING_LIMIT_C2', 'CURRENCY_CODE_3', 'MINIMUM_AMOUNT_C3', 'FLOOR_LIMIT_C3', 'CEILING_LIMIT_C3', 'CURRENCY_CODE_4', 'MINIMUM_AMOUNT_C4', 'FLOOR_LIMIT_C4', 'CEILING_LIMIT_C4', 'CURRENCY_CODE_5', 'MINIMUM_AMOUNT_C5', 'FLOOR_LIMIT_C5', 'CEILING_LIMIT_C5', 'CURRENCY_CODE_6', 'MINIMUM_AMOUNT_C6', 'FLOOR_LIMIT_C6', 'CEILING_LIMIT_C6', 'CREDIT_NOTE_FLAG', 'dail_hour', 'DIAL_PREFIXE', 'TONE_PULSE_FLAG', 'PIN_KEY_NUMBER', 'TRANSPORT_PIN_KEY_NUMBER', 'MAC_KEY_NUMBER', 'MASTER_KEY_NUMBER', 'U_PASSWORD',
