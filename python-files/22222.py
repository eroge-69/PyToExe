...
class SalaryManagerApp:
    ...
    def display_selected_employee_info(self, event=None):
        ...
        if selected_employee:
            ...
            self.info_monthly_salary.config(text=f"Monthly Salary: ${selected_employee.monthly_salary:.2f}")
            self.info_remaining_salary.config(text=f"Remaining Salary: ${selected_employee.remaining_salary:.2f}")
        else:
            self.clear_employee_info_display()
    ...
    def record_payment(self):
        ...
        if selected_employee.record_payment(payment_amount, reason):
            messagebox.showinfo("Payment Recorded", f"Payment of ${payment_amount:.2f} recorded for {selected_employee.name}.\nRemaining Salary: ${selected_employee.remaining_salary:.2f}")
    ...
    def export_employee_data(self):
        ...
        try:
            with open(file_path, "w") as f:
                ...
                f.write(f"Monthly Salary: ${selected_employee.monthly_salary:.2f}\n")
                f.write(f"Remaining Salary: ${selected_employee.remaining_salary:.2f}\n")
                f.write("\n--- Payment History ---\n")
                if not selected_employee.payment_history:
