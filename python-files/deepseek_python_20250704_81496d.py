...
webbrowser.open('https://t.me/AlphaX_Zone')
time.sleep(2)
...
class UserAgentGenerator:
    ...
    def _generate_facebook_user_agent(self):
        ...
        lang = random.choice(('en_US', 'en_GB', 'en_PK'))
...
# ===================================================================
# Device Information Gathering (Windows compatible)
# ===================================================================

try:
    android_version = "Windows"
    model = platform.system() + " " + platform.release()
    build = platform.version()
    fblc = 'en_US'
    fbcr = 'N/A'
    fbmf = platform.machine()
    fbbd = platform.node()
    fbdv = model
    fbsv = platform.version()
    fbca = platform.architecture()[0]
    fbdm = '{density=1.0,width=1920,height=1080}'
except Exception:
    fbcr = 'Zong'
    android_version = "Windows"
    model = "PC"
...
ua = '[Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5779.200 Safari/537.36]'
...
\x1b[1;96m   ➤ \x1b[1;97mRunning On     : \x1b[1;94mWindows
\x1b[1;92m─────────────────────────────────────────────────────────''')
...
class ASIMCracker:
    ...
    def handle_success(self, uid, password, response):
        ...
        file_path = os.path.join(desktop_path, 'ASIM-OLD.txt')
    ...
    def display_results(self):
        ...
        desktop_path = os.path.join(os.path.expanduser('~'), 'Desktop')
        print(f'  {self.color.W}Results saved to: {self.color.C}{desktop_path}\\ASIM-OLD.txt')
