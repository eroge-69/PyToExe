...
COLOR_FOREGROUND_MAIN_WINDOW = "#000000"
COLOR_LABELS_BORDERS = "#DDDDDD" 
COLOR_INPUT_BACKGROUND = "#000000"
COLOR_INPUT_TEXT = "#FA0202"
COLOR_LOG_TEXT = "#FD0404"
COLOR_BUTTON_BACKGROUND = "#F50707"
COLOR_BUTTON_TEXT = "#FC0000"
COLOR_BUTTON_BORDER = "#EB0D0D"


COLOR_ERROR_BORDER = "#FF0000"


APP_IMAGE_URL = "https://i.pinimg.com/736x/19/64/4e/19644e78fffbb506ba86feb33b5a9822.jpg"
...
class AttackThread(QThread):
    ...
    def run(self):
        ...
        """
        self.log_signal.emit(" P o C ACTIVATED! TARGET LOCKED! \n")
        if self.use_proxy:
        ...
        if self.running:
            self.log_signal.emit("\n P o C FINISHED. TARGET ELIMINATED. ")
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("P o C by ʘxV1яυŜ")
        ...
        self.credit_label = QLabel("by ʘxV1яυŜ")
        ...
        self.start_button = QPushButton("LAUNCH P o C")
    ...
    def load_image_from_url(self, url):
        ...
        try:
            ...
            if not pixmap.isNull():
                ...
                self.log_message(" IMAGE LOADED! P o C IS READY!")
            else:
    ...
    def start_attack(self):
        ...
        self.log_message(" Launching P o C ...")
