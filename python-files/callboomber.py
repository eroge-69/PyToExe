...
# Renk kodlari
turkuaz = '\033[36m'
turuncu = '\033[38;5;208m'  # Ozel renk kodu
yesil = '\033[32m'
parlak_mavi = '\033[94m'
reset = '\033[0m'
...
def send_spam(phone_number):
    ...
    if response.status_code == 200:
        print(f"{yesil}Islem basariyla tamamlandi.{reset}")
    else:
        print('Arama gonderilemedi.')

phone_number = input(f"{turuncu}Ornek no: +905555555555 : {reset}")
