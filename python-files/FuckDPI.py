...
''')
        self.print(
            "\033[31m" +
            "by leikimia: / #культ_избранных:".center(50) +
            "\n\t              @kultweb\n" + 
            "\033[0m"
        )
        ...
        def print_connection_status():
            ...
            time.sleep(1)
            print("creating TMP dump...")
            time.sleep(1)
            print("booting up files stairs...")
            time.sleep(3)
            print("\nprotocol started [ASQ]")
            time.sleep(2)
            print("starting [MS]")
            time.sleep(1)
            print("fraiming...")
            print("\nserver booted...")
            time.sleep(0.1)
            print("sv protocol [MS]")
            time.sleep(0.1)
            print("sv warp [127.0.0.1]")
            time.sleep(0.1)
            print("dns [0.0.0.0] // [1.1.1.1]")
            time.sleep(0.1)
            print("generated bypass [QWR]")
            time.sleep(0.1)
            print("HTTP [dislocated] // [80]")
            time.sleep(0.1)
            print("HTTPS [opened] // [440]")
            time.sleep(0.1)
            print("geo [generated]")
            time.sleep(0.1)
            print(
                "user_agent [generated] // [Mozilla/5.0 (Windows; U; Windows NT 6.1; WOW64; en-US) Gecko/20130401 Firefox/59.5]")
            time.sleep(1)
            print("\npreset logged [QWS]")
            print("Cult bypass [started]")
            print("started at ip: 127.0.0.1 | port: 8881")

        print_connection_status()


        self.print(f"".center(50))
        self.print("\n")
        self.print(
            f""
        )
        if not self.no_blacklist:
            self.print(
                f"\033[92m[data]:\033[97m list contains {len(self.blocked)} domains"
            )
        self.print(
            "\033[92m[data]:\033[97m To stop the service, press Ctrl+C twice")
        if self.log_err_file:
            self.print(
                "\033[92m[data]:\033[97m Logging is in progress. You can see the list of errors in the file "
                f"{self.log_err_file}"
            )
    ...
    async def display_stats(self):
        ...
        while True:
            ...
            stats = (
                ...
                f"\033[97mSpeed: \033[96m{self.format_speed(self.speed_in)}\033[0m | "
                f"\033[97mSpeed: \033[96m{self.format_speed(self.speed_out)}\033[0m"
            )
