...
class NotaPro(tk.Tk):
    def __init__(self):
        ...
        # Fonte padrão. O tamanho será ajustado pelo zoom.
        ...
        # ---- NOVO: Lógica para abrir arquivo via argumento de linha de comando ----
        if len(sys.argv) > 1:
    ...
    def _create_widgets(self):
        self.text_widget = tk.Text(self, undo=True, wrap=tk.WORD, font=(self.default_font_family, self.default_font_size))
    ...
    def _load_file_from_path(self, filepath):
        """Carrega um arquivo a partir de um caminho, atualizando a interface."""
        try:
            self._new_file()  # Limpa o editor
            ...
            self._new_file() # Reseta para um estado limpo se a abertura falhar
