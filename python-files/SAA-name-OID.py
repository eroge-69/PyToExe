...
btn = tk.Button(window, text="Convert to OID", command=generate_oid, bg="#0078d7", fg="white",
                font=("Segoe UI", 11), relief="ridge", width=20)
btn.pack(pady=10)

result_text = tk.Text(window, wrap="word", height=18, width=80, font=("Consolas", 11),
                      bg="#2d2d2d", fg="#dcdcdc")
result_text.pack(padx=10, pady=10)

# Footer signature
footer = tk.Label(window, text="made by mustafa sabah", fg="#666", bg="#1e1e1e",
