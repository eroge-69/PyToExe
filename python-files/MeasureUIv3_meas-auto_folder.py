...
# Set all paths:
json_file_path = Path("D:\\Automation\\Measure-Automation\\measure_gui\\CFG\\masterconfig.json")
AH_script = Path("D:\\Automation\\Measure-Automation\\measure_gui\\STUDY\\AH\\AH_script.ps1")  
ULH_script = Path("D:\\Automation\\Measure-Automation\\measure_gui\\STUDY\\ULH\\ULH_script.ps1")  
log_dir = Path("D:\\Automation\\Measure-Automation\\measure_gui\\LOGS")
