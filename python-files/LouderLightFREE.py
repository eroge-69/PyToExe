...
def run_cheat():
    ...
    client_path = "C:\\LightClient"
    if not os.path.isdir(client_path):
        os.mkdir(client_path)

    download_and_extract(
        url="https://www.dropbox.com/scl/fi/d8bkp2awul9mnczlg8qtt/client.zip?rlkey=5cx6ucnjwzn9aoltgsvtmh57f&st=cv7fd3qo&dl=1",
