...
class calenar_window:
    def __init__(self):
        ...
        root.config(bg='#1f77b4')
        Tk.Label(root,text="Период прецессии, земные сут.", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=10)
        Tk.Label(root, text="Сидерический период, земные сут. ", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=50)
        Tk.Label(root, text="Период обращения, земные сут.", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=90)
        Tk.Label(root, text="Количество месяцев", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=150)
        Tk.Label(root, text="Количество дней в неделе", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=190)
        Tk.Label(root, text="Год в местном календаре", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=230)
        Tk.Label(root, text="Название планеты", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=270)
        Tk.Label(root, text="Результат", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=310)
        Tk.Label(root, text="Тропический период", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=350)
        Tk.Label(root, text="Номер високосного года", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=390)
        Tk.Label(root, text="Номер усечённого високосного года", font=('Arial,15,bold'),bg='#1f77b4').place(x=10,y=430)
        ...
        Tk.Label(root, textvariable=self.result,font=('Arial,15,bold'),bg='#1f77b4').place(x=350,y=310)
        self.tropical_period=Tk.StringVar()
        Tk.Label(root, textvariable=self.tropical_period,font=('Arial,15,bold'),bg='#1f77b4').place(x=350,y=350)
        self.number_of_lead_year=Tk.StringVar()
        Tk.Label(root, textvariable=self.number_of_lead_year,font=('Arial,15,bold'),bg='#1f77b4').place(x=350,y=390)
        self.number_of_truncated_lead_year=Tk.StringVar()
        Tk.Label(root, textvariable=self.number_of_truncated_lead_year,font=('Arial,15,bold'),bg='#1f77b4').place(x=350,y=430)
