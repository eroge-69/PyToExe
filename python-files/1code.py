...
# Main GUI
root = tk.Tk()
root.title("Advanced User-Agent Generator @Developed by Rony Mitu")
root.geometry("900x700")
root.config(bg="#282c34")

# Header
title_label = tk.Label(root, text="Advanced User-Agent Generator @Developed by Rony Mitu", font=("Helvetica", 18, "bold"), bg="#61afef", fg="white", pady=10)
