...
def generate_user_agent(device, os_choice, browser_choice, count):
    ...
    for _ in range(count):
        if device == "Desktop":
            ...
            ua = template.format(
                os=os,
                chrome_version=f"{random.randint(130, 137)}.0.{random.randint(4000, 5000)}.{random.randint(50, 150)}",
                firefox_version=f"{random.randint(80, 130)}.0",
                edge_version=f"{random.randint(80, 130)}.0.{random.randint(4000, 5000)}",
            ...
            if os_choice == "Android":
                ua = template.format(
                    ...
                    chrome_version=f"{random.randint(120, 137)}.0.{random.randint(4000, 5000)}.{random.randint(50, 150)}"
                )
            elif os_choice == "iOS":
                ua = template.format(
