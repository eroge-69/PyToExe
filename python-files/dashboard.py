...
class IMS:
    def __init__(self,root):
        ...
        self.root.title("Inventory Management System | ARPIT TIWARI and AKANKSHA MISHRA")
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by ARPIT TIWARI and AKANKSHA MISHRA\nFor any Technical Issues Contact: 6306470074",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
